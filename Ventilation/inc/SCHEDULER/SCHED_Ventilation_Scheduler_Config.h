...
/*removing this driver functions
DRV_USB_LAUNCH_TACHE15 = 0;
MONIT_FLASH_TACHE_13 = 0;
TREND_FLASH_TACHE_14 = 0;
*/ //by bhavya
...
#define SCHED1_STEP_1_ACTIVABLE_TASKS  SYS_INTERPOLATION_TACHE4 + DRV_EVENT_TACHE9 + DISPLAY_FIFO_READ_TACHE10 + TIM_LAUNCH_TACHE3 + SYS_LAUNCH_TACHE2 + VEN_CYCLES_TACHE5 + VEN_ACTUATORS_TACHE7 + VEN_SECURITY_TACHE8 + KEY_EVENT_LAUNCH_TACHE12 + COM_LAUNCH_TACHE_16 + DRV_SPI_POWERSUPPLY_UPDATE_TACHE_17
...
#define SCHED1_STEP_2_ACTIVABLE_TASKS SYS_INTERPOLATION_TACHE4 + DRV_EVENT_TACHE9 + DISPLAY_FIFO_READ_TACHE10 + VEN_COMPUTE_TACHE6 + COM_LAUNCH_TACHE_16 + DRV_SPI_POWERSUPPLY_UPDATE_TACHE_17
...
#define SCHED1_STEP_3_ACTIVABLE_TASKS  SYS_INTERPOLATION_TACHE4 + DRV_EVENT_TACHE9 + DISPLAY_FIFO_READ_TACHE10 + TIM_LAUNCH_TACHE3 + SYS_LAUNCH_TACHE2 + VEN_CYCLES_TACHE5 + VEN_ACTUATORS_TACHE7 + VEN_SECURITY_TACHE8 + KEY_EVENT_LAUNCH_TACHE12 + COM_LAUNCH_TACHE_16 + DRV_SPI_POWERSUPPLY_UPDATE_TACHE_17
...
#define SCHED1_STEP_4_ACTIVABLE_TASKS  SYS_INTERPOLATION_TACHE4 + DRV_EVENT_TACHE9 + DISPLAY_FIFO_READ_TACHE10 + VEN_COMPUTE_TACHE6 + IT_WATCHDOG_TACHE1 + IHM_LAUNCH_TACHE11 + COM_LAUNCH_TACHE_16 + DRV_SPI_POWERSUPPLY_UPDATE_TACHE_17

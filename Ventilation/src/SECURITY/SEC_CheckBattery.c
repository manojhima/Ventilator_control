...
SFSYSTEV3.27
CHECK BATTERY
the software shall record this event when the CHECK BATTERY alarm is detected

SFSYSTEV3.28
END OF CHECK BATTERY
the software shall record this event when the CHECK BATTERY alarm is cancelled
...
#include "../SECURITY/SEC_CheckBattery.h"

...
/*                            FUNCTION BODY                                   */
/******************************************************************************/
int ALIM_FAILURE_5VREF_1  =	0;
int ALIM_FAILURE_10VREF_1  =	0;
...
/*%C  if ALIM_FAILURE_5VREF = FALSE or ALIM_FAILURE_10VREF = FALSE, then	  */
		if ( (ALIM_FAILURE_5VREF_1 == FALSE)
		  || (ALIM_FAILURE_10VREF_1 == FALSE) )
		{
...
/*%C  Priority register update                                 				  */
		...
		else if ( (ALIM_FAILURE_5VREF_1 == TRUE)
		  && (ALIM_FAILURE_10VREF_1 == TRUE) )
		{

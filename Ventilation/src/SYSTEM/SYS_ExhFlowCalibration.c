...
/*%C Sending the type of regulation needed */
	...
	DB_ControlWrite(SETUP_CONTROL_SET_POINT_U16, (UWORD16)((UWORD32)CP.CalibPoint[Indice] * 100/10));  // convertit en 10�me de mbar ou de dl 
...
/*%C Check if measured flow is out of range (Min & max) */
	if ( (FilterQi > ToleranceMore) 
     || (FilterQi < ToleranceLess) ) // conversion en 10�me de mbar ou de dl 

...
/* Timer 5 declaration  */
   ...
   /* Registre de controle du timer T5	*/
	/* Pr�diviseur = 24 T5I = 111	*/  
	/* Mode timer 	   T5M = 000	*/
	/* Timer en marche T5R = 1	*/
	/* Direction "d�comptage" sans tenir compte de l'entr�e T5 T8EUD = 01	*/
	/* Contr�le de la sortie T8OUT P31 	non utilis�e.T5OE = 0	*/
	/* latch de la sortie T5OL = 0	*/
	/* Bit 11 12  13 14 15 non utilis�s = 00000	*/
	/* Controle du mode reload pas de reload � partir de CAPREL	 T5SR = 0	*/

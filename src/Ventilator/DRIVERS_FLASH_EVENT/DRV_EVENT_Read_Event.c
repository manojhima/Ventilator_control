...
//	Start_Last_Event = (UWORD16 xhuge *)((UWORD32)(EVENT_FLASH_START_ADDRESS + ((UWORD32)Ptr_Flash / EVENT_Last_Event_Parameter) * EVENT_Last_Event_Parameter));
	Start_Last_Event = (UWORD16 *)((UWORD32)(EVENT_FLASH_START_ADDRESS + ((UWORD32)Ptr_Flash / EVENT_Last_Event_Parameter) * EVENT_Last_Event_Parameter));
	}
...
//	Start_Last_Event = (UWORD16 xhuge *)((UWORD32)(EVENT_FLASH_START_ADDRESS + ((UWORD32)Ptr_retrieval / EVENT_Last_Event_Parameter) * EVENT_Last_Event_Parameter));
	Start_Last_Event = (UWORD16 *)((UWORD32)(EVENT_FLASH_START_ADDRESS + ((UWORD32)Ptr_retrieval / EVENT_Last_Event_Parameter) * EVENT_Last_Event_Parameter));
	}
...
adr_Suspend = (UWORD16 *)EVENT_FLASH_START_ADDRESS;
...
/*%C Interruption of erazing sequence					 */
	*Erase_Adress = 0x00B0;
	...
	Suspend_Erase = TRUE;
/*%C Tempo 24.8�s  waiting validation of erazing				 */
/*%C Tempo v�rified with oscilloscope								 */
	for (i=0;i<165;i++) 
		{
		_nop_();
		}
...
//					 - ((UWORD32)num_event * (UWORD32)EVENT_Last_Event_Parameter) + id_event));
		adr_Read = (UWORD16 *)((UWORD32)((UWORD32)Start_Last_Event
							 - ((UWORD32)num_event * (UWORD32)EVENT_Last_Event_Parameter) + id_event));
		value = *adr_Read;
		value &= 0xFF;
		}
...
//					+ (UWORD32)Start_Last_Event + id_event));
		adr_Read = (UWORD16 *)((UWORD32)((UWORD32)End_Of_Event_Flash
					- ((UWORD32)num_event * (UWORD32)EVENT_Last_Event_Parameter) 
					+ (UWORD32)Start_Last_Event + id_event));
		value = *adr_Read;
		}																							

...
//#endif
{  
	PECC0 = 0x0210 ;			  		    			// R�initialisation du compteur de PECC
	DSTP0 = _sof_(conversion_numerique);    	// R�initialisation du pointeur DESTINATION du PECC0

	// affectation du r�sultat de conversion

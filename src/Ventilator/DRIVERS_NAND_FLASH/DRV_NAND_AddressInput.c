							...
							UWORD16 Column_Number )
{
	UBYTE Five_Addressing_Cycles = 
   	...
   	/* D�claration du pointeur d'adresse en local */
   	UBYTE *MONITFLASH_Data = (UBYTE *)MONITORING_FLASH_POINTER_ADDRESS;

	/* D�claration des variables pour le passage des adresses sur quelques Cycles)*/
	...
	/* Mise � niveau signaux de commande */
	ALE_ME1 = 1 ;
	CMD_ME1 = 0 ;
	...
	*MONITFLASH_Data = CycleAdr4 ; /* Octet 4 */
	...
	/* Laisser le temps au �c d'envoyer la commande sur le bus*/
	_nop_() ;

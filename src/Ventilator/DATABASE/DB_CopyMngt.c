...
void DB_CopyMngt(void)
{
    ...
    /* "Etude Soft\Analyse Data Base\Gestion  des  r�glages  des  param�tres.doc" */
    /* V�rifier qu'on ne recopie la base dans current que lorsqu'on a modifie     */
    /* un param�tre (sauf lors d'un changement de mode)                           */
    /*  => cr�er un flag modif_param (data globale)                               */

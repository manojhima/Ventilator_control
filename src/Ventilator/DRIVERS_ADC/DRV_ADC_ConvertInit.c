...
void DRV_ADC_ConvertInit(void)
{
	...
	// Registre de contr�le du convertisseur ad ADCON
		// s�lection du canal 15 ADCH = 1111
		// conversion unique sur plusieurs canaux ADM = 10
		// pas de d�marrage de la conversion ADST = 0
	...
	// Registre PECC0
		// Nbre de donn�es � transf�rer 14 COUNT = 00001110 
		// Largeur de la donn�e � transf�rer 16 bits BWT = 0
		// Incr�mentation du pointeur de destination 	INC = 01
	...
	// Pointeur destination  pointe sur le tableau des r�sultats de conversion de toutes les voies

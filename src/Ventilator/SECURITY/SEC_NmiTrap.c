...
#include "../SECURITY/SEC_NmiTrap.h"
...
/*%C Demande d'ouverture de l'afficheur */
	...
	T2IR = 0;		
	T2IC = 0;
	/*%C 5000*200ns, duree du timer2 = 1 ms Temps allou� a l'ex�cution */
	T2 = 5000;   	
...
/*%C Si coupure ou baisse  de l'alimentation alors que l'init n'est pas termin�e => ne pas executer le trap*/
...
/*%C			Incr�asing programing adress */
				adr_flash++;
				}
			}
...
/*%C  24.8�s delay : waiting erazing validation    	*/

...
typedef enum
{
	...
	COM_RX_B1_START_FRAME = 0, //1ier octet d'ent�te de trame
	COM_RX_B2_START_FRAME, 	   //2i�me octet d'ent�te de trame	
	COM_RX_B3_START_FRAME, 	   //3i�mer octet d'ent�te de trame		
	COM_RX_COMMAND, 		   //indentifiant de commande de trame
	COM_RX_NB_ARG,			   // nombre d'arguments (donn�es dans la trame 				
	COM_RX_BufferSize = 96	   //Taille du buffer de reception liaison s�rie			
}e_COM_RX_REMOTE;
...
typedef enum
{
	...
	COM_TRANSMIT_STOP	      			 // arr�t de la transmission
}e_COM_STATE;

...
/*%C Mesure des temps de t�ches */

/*%C Temps au repos sans clef */
/* Maximum = 39,2 �s */

/*%C Temps au repos (sans action IHM) avec cl� */
/* Maximum = 42 �s */

/*%C Temps avec commande d'effacement total */
/* Maximum = 17 �s */

/*%C Temps avec commande d'�criture de r�glage sur cle */
/* Maximum = 45 �s */

/*%C Temps avec commande de lecture de r�glages sur cle */
/* Maximum = 75 �s */

/*%C Temps avec commande de transfert en continu */
/* Maximum = 97 �s */

/*%C Temps avec commande de monitorage detaill� */
/* Maximum = 434 �s */
...
#include "../DRIVERS_NAND_FLASH/DRV_NAND_ReadID.h"
...
/*%C Reset the bridge 																			*/
/******************************************************************************/
		/*%C Reset the bridge during 1.6�s minimum (Using T2)*/
		RESET_USB = 0;
		/*%C Raz flag underflow timer 2 														*/
		T2IR = 0 ;
		/*%C 16 * 200ns, duree du timer 2 = 3.2 �s 				*/
		T2 = 16 ;
...
/******************************************************************************/
	/*%C Permet d'envoyer le message contenu dans la pile � l'IHM			*/
	DRV_USB_ReadFifo();

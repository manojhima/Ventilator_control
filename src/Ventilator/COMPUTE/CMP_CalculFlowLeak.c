...
/*%C If we are in single branch without a pediatric circuit and PEEP is over 9cmH2O */  
	...
	/*%C correction value                                                         */
			...
			{
		      // D�cr�ment de la consigne avec un coefficient inversement proportionnel � la Pep
...
/******************************************************************************/	
	...
	/*%C correction value                                                         */
			...
			{
			  // D�cr�ment de la consigne avec un 50*100coefficient inversement proportionnel � la Pep
